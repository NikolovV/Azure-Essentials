...
<?php
	...
	$connectionInfo = array("UID" => "demouserdb", "pwd" => "DemoPasswordDB-2021", "Database" => "vnsolsqldb", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
	$serverName = "tcp:vnsolsqlsrv.database.windows.net,1433";
