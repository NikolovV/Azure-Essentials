...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    if (name != null) 
    {
        ...
        var str = "Server=tcp:su5afdsqlserv.database.windows.net,1433;Initial Catalog=su5afd-db;Persist Security Info=False;User ID=demouserdb;Password=DemoPasswordDB-2021;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
